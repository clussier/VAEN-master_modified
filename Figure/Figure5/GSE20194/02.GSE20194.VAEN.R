setwd("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/Figure/Figure5/GSE20194/")

### key genes
cur.genes = read.table("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/result/key.genes.txt", as.is=T)
...
write.table(scaled.GSE20194.gene.mat, file=paste("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/Figure/Figure5/GSE20194/GSE20194.RANK.tsv", sep=""), row.names=T, quote=F, sep="\t")
##########################################################################
...
load("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/result.EN/dr.CCLE/dr.CCLE.A.models.RData")
drug = "Paclitaxel"
...
# python3 VAE.prediction.py <best.index> <path/to/GSE20194.RANK.tsv> </extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/result/>
...
load("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/result.EN/dr.GDSC/dr.GDSC.A.models.RData")
drug = "Paclitaxel"
...
##########################################################################
# Go to a shell, and run VAE.prediction.py using best.index obtained above
# python3 VAE.prediction.py <best.index> <path/to/GSE20194.RANK.tsv> </extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/result.EN/dr.CCLE/GitHub/result/>
# After finish the above python code, a new file will be generated: GSE20194.RANK.<best.index>.latent.tsv
##########################################################################
