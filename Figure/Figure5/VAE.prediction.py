...
# cd /extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/Figure/Figure5/
# python3 ../VAE.prediction.py 11 GSE20194.RANK.tsv /extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/result/
################################
