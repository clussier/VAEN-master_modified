...
latent = read.table("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/vaen_rerun/result/f.C1.CCLE.latent.tsv", as.is=T, header=T)
...
pdf("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/vaen_rerun/1C.CCLE-tSNE.pdf", width=7, height=7)
