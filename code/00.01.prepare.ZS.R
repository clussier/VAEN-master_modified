...
original.TCGA.RPKM = read.delim("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/DATA/TCGA/ACC/HiSeqV2", as.is=T)
...
##########################################################################
write.table(scaled.ccle.train.mat, file=paste("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/vaen_rerun/CCLE.4VAE.ZS.tsv", sep=""), row.names=T, quote=F, sep="\t")
write.table(scaled.RPKM.mat, file=paste("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/vaen_rerun/TCGA.4VAE.ZS.tsv", sep=""), row.names=T, quote=F, sep="\t")
##########################################################################
