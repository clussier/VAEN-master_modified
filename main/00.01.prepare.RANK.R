setwd("/extraspace/ychen42/Drug_Response/VAEN-master/main")
setwd("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/vaen_rerun/")
#  wget -r https://bioinfo.uth.edu/VAEN/DATA/TCGA/ /extraspace/ychen42/Drug_Response/VAEN-master/DATA/TCGA/
### transcriptome data
