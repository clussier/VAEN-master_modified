...
plt.savefig('/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/vaen_rerun/books_read.png')

vae.compile(optimizer=adam, loss=None, loss_weights=[beta])

vae.summary()

#output_model_file = os.path.join('/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/vaen_rerun/', 'onehidden_vae_architecture.png')
#output_model_file = os.path.join('/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/vaen_rerun/', 'onehidden_vae_architecture.png')
#plot_model(vae, to_file=output_model_file)
#SVG(model_to_dot(vae).create(prog='dot', format='svg'))
...
#encoder_model_file = os.path.join('/data1_2/jiap/projects/18-CCLE-VAE/SCALE', 'CCLE_encoder_onehidden_vae.hdf5')
#decoder_model_file = os.path.join('/data1_2/jiap/projects/18-CCLE-VAE/SCALE', 'CCLE_decoder_onehidden _vae.hdf5')
