...
ccle = read.table("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/DATA/CCLE/CCLE_DepMap_18q3_RNAseq_RPKM_20180718.gct", skip=2, sep="\t", header=T, as.is=T)
any.TCGA.RPKM = read.delim("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/DATA/TCGA/ACC/HiSeqV2", as.is=T)
...
cancer.types = dir("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/DATA/TCGA/")
...
for(k in 1:length(cancer.types)){
	...
	original.TCGA.RPKM = read.delim(paste("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/VAEN/DATA/TCGA/",cancer,"/HiSeqV2", sep=""), as.is=T)
...
write.table(scaled.ccle.train.mat, file=paste("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/vaen_rerun/V15.CCLE.4VAE.SZ.tsv", sep=""), row.names=T, quote=F, sep="\t")
write.table(scaled.RPKM.mat, file=paste("/extraspace/ychen42/Drug_Response/bioinfo.uth.edu/vaen_rerun/V15.TCGA.4VAE.SZ.tsv", sep=""), row.names=T, quote=F, sep="\t")
##########################################################################
